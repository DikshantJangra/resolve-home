...
export const BookingHeader = ({ title, subtitle, currentStep, totalSteps }: BookingHeaderProps) => {
    ...
    <div className="w-full space-y-6 p-5">
      <div className="flex items-center justify-between">
        ...
        >
          ...
          <span className="text-base font-normal font-['Inter'] leading-6">Close</span>
        </button>
      </div>
