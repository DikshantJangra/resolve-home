...
export default function DashboardLayout({
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      ...
      <div className={cn(
        "fixed inset-y-0 left-0 z-[100] w-48 transform transition-transform duration-300 ease-in-out lg:fixed lg:h-screen lg:translate-x-0 lg:z-[100] lg:pointer-events-auto",
