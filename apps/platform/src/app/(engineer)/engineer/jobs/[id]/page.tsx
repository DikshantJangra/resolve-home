...
import { useEngineerBookingDetail, useAcceptJob, useRejectJob, useCompleteJob } from '@/hooks/api-hooks'
import { cn } from "@resolve/ui"

export default function JobDetailsPage() {
  const { id } = useParams()
  const router = useRouter()
  const { data: job, isLoading, error } = useEngineerBookingDetail(id as string)
