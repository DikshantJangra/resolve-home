...
const defaultSidebarItems: SidebarItem[] = [
  ...
  { label: 'Subscriptions', icon: HiOutlineCreditCard, href: '/subscriptions', hideForEngineers: true },
...
export const Sidebar = ({ onClose, items }: SidebarProps) => {
  ...
  const isEngineer = userProfile?.user?.role === 'worker' || userProfile?.role === 'worker' || (userProfile as any)?.role === 'worker'
  const isVerified = !!(
