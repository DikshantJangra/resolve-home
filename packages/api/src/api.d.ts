...
export interface paths {
    ...
    "/api/admin/users/stats": {
        ...
        /** Get homeowner statistics (Admin) */
        get: {
            parameters: {
                query?: never;
                header?: never;
            ...
            requestBody?: never;
            responses: {
                /** @description Homeowner statistics */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
        ...
        get: {
            parameters: {
                query?: {
                    ...
                    status?: "pending" | "confirmed" | "in-progress" | "completed" | "cancelled" | "active" | "upcoming";
                };
                header?: never;
                path?: never;
                cookie?: never;
    ...
    "/api/engineer/profile": {
         ...
         * @description Engineers must complete their profile including skills and certification before they can accept bookings.
         */
        post: {
            parameters: {
                query?: never;
    ...
    "/api/engineer/bookings": {
        ...
        /** Get engineer bookings with filters */
        get: {
            parameters: {
                query?: {
                    status?: "pending" | "confirmed" | "active" | "completed" | "cancelled" | "upcoming";
                };
                header?: never;
                path?: never;
                cookie?: never;
    ...
    "/api/engineer/bookings/{id}/accept": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/engineer/bookings/{id}/reject": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/chats": {
         ...
         *     **Send message:**
         *     ```javascript
         *     socket.emit('send_message', { chatId, message: 'Hello!', type: 'text' });
         *
         ...
         *       // message: { id, chatId, senderId, message, type, fileUrl, fileType, isRead, createdAt }
         *     });
         *     ```
         *
         *     **Typing indicator:**
